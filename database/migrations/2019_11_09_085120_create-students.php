...
class CreateStudents extends Migration
{
    ...
    public function up()
    {
        Schema::create('students', function (Blueprint $table) {
            ...
            $table->text('student_certificate_number');
            $table->text('student_national_number')->nullable();
            $table->text('student_father_name');
            $table->text('student_father_mobile')->nullable();
            $table->text('student_mother_mobile')->nullable();
            $table->text('student_birthday')->nullable();
            $table->text('student_student_section')->nullable();
            $table->text('student_student_basic');
            $table->text('student_student_class');
            $table->text('student_student_number');
