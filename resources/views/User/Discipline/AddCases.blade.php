                                            ...
                                            <div class="row">
                                                ...
                                                <div class="row">
                                                        <div class="col-md-12">
                                                                <div class="custom-control custom-radio custom-control-inline">
                                                                        <input type="radio" value="1"  id="customRadioInline1" name="case_effect" class="custom-control-input">
                                                                        <label class="custom-control-label" for="customRadioInline1"> دارد </label>
                                                                    </div>
                                                                    <div class="custom-control custom-radio custom-control-inline">
                                                                        <input type="radio" value="0"  id="customRadioInline2" name="case_effect" class="custom-control-input">
                                                ...
                                                <div class="row">
                                                        <div class="col-md-12  my-3">
                                                                <h6 > <span class="text-danger">*</span> پس از اضافه کردن دانش اموزان از جدول , دکمه تایید را بزنید  </h6>
                                                        ...
                                                        <tr>
                                                                ...
                                                                <td>
                                                                 <div class=" custom-checkbox">
                                                                    <input value=" {{$students->student_id}} " type="checkbox" name="student_ids[]" class="custom-check1" id="customCheck" >
                                                                 </div>
                                                                </td>
