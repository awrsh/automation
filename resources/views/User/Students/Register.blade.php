                                ...
                                <section>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6 wd-xs-300">
                                            ...
                                            <input type="text" name="serial_certificate_number" required
                                                   class="form-control">
                                    ...
                                    <div class=" row">
                                        <div class="form-group col-md-6 wd-xs-300 mt-3">
                                            <label> معدل سال گذشته</label>
                                            <input type="number" name="Average_student" id="student_mobile" required
                                                   class="form-control text-right" dir="ltr">
                                            <p class="errorMassage" id="massage-student_mobile"></p>
                                        </div><!-- form-group -->
                                        ...
                                        <div class="form-group col-md-6 wd-xs-300 mt-3">
                                            <label> آدرس</label>
                                            <textarea name="address_student" id="content" rows="10"
