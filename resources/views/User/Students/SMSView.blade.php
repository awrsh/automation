                            ...
                            <div id="wizard2">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6 wd-xs-300">
                                        ...
                                        <input type="number" name="title" value="" class="form-control" required>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mt-2">
                                        <label for="">ارسال پیامک برای :</label>
                                        <select name="sms_mobile" class="custom-select form-control custom-select-sm mb-3">
                                           @if($student->student_student_mobile !== null)
                                                <option value="{{$student->student_student_mobile}}">دانش آموز</option>
                                               @endif
                                            @if($student->student_father_mobile !== null)
                                                   <option value="{{$student->student_father_mobile}}">پدر دانش آموز</option>
                                                @endif
                                               @if($student->student_mother_mobile !== null)
                                                   <option value="{{$student->student_mother_mobile}}">مادر دانش آموز</option>
                                               @endif
                                        </select>
                                    </div>
                                </div>
                                <div class=" row">
                                    <div class="form-group col-md-6 wd-xs-300 mt-3">
...
@section('css')
    ...
    <!-- begin::form wizard -->
    <link rel="stylesheet" href=" {{route('BaseUrl')}}/Pannel/assets/vendors/form-wizard/jquery.steps.css"
          type="text/css">
    <style>
        input.error {
