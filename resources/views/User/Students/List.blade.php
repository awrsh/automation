                        ...
                        @foreach ($classes as $key=>$item)
                            <li class="nav-item">
                                <a class="nav-link {{$key == 0 ? ' active':''}}" id="pills-{{$item->class_id}}-tab"
                                   ...
                                   aria-selected="false">{{$item->class_name}}</a>
                            </li>
                        @endforeach
                                            ...
                                            <tr>
                                                ...
                                                @else
                                                    <td><a class='btn btn-danger btn-sm'
                                                           href='{{route('Student.EditStudent')}}/{{$students->student_id}}'>ثبت
                                                            نام</a></td>
                                                @endif
                                                ...
                                                @else
                                                    <td><a class='btn btn-danger btn-sm'
                                                           href='{{route('Student.EditStudent')}}/{{$students->student_id}}'>تعیین
                                                            پایه</a></td>
                                                    <td><a class='btn btn-danger btn-sm'
                                                           href='{{route('Student.EditStudent')}}/{{$students->student_id}}'>تعیین
                                                            کلاس</a></td>
                                                ...
                                                <td class="text-center"><a class='btn btn-success '
                                                                           href='{{route('Student.SendSMSView',$students)}}'>
