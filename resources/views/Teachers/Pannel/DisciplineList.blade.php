...
<div class="container-fluid">
    ...
    <ul class="nav nav-pills mb-3" id="pills-tab2" role="tablist">
        ...
        <li class="nav-item">
            <a class="nav-link {{$count == 0 ? 'active':''}}" id="pills-{{$key}}-tab" data-toggle="pill"
    ...
    <div class="tab-content" id="pills-tabContent2">
        ...
        <div class="tab-pane fade {{$count == 0 ? 'show active':''}}" id="pills-{{$key}}" role="tabpanel"
            ...
            <table class="table table-striped table-bordered example2">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>20</td>
                        <td>
                            <a href=" {{route('Teachers.WorkSpace.DisciplineShow',$students)}} " class=" text-center"><i
