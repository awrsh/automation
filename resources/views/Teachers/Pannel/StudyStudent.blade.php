                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($studyForLesson as $item)
                                      ...
                                      @endphp
                                    <tr>
                                        <td scope="row"> {{\App\LessonModel::where('id',request('l'))->first()->lesson_name}} </td>
                                        <td>{{$item->studies_students_count}}</td>
                                        <td>{{ $StudyNormalCount}}</td>
                                        <td>  {{\Morilog\Jalali\Jalalian::forge($item->studies_students_date)->format('%B %d، %Y')}} </td>
                                        @if ($item->studies_students_count > $StudyNormalCount)
                                            <td>
                                                مطلوب
                                            </td>
                                            @else
