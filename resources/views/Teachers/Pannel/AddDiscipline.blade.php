                            ...
                            <ul class="nav nav-pills mb-3" id="pills-tab2" role="tablist">
                               ...
                               <div class="tab-content" id="pills-tabContent2">
                                @foreach($teacher_lessons as $key=>$item)   
                                 ...
                                 <div class="tab-pane fade {{$key == 0 ? 'show active':''}}" id="pills-{{$item->id}}" role="tabpanel" aria-labelledby="pills-{{$item->id}}-tab">
...
type:'get',
url:"{{url('Manager/discipline/student_chart')}}",
data:{id:id},
