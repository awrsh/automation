             ...
             <li class="nav-item dropdown">
                 <a href="#" data-toggle="dropdown">
                     <figure class="avatar avatar-sm avatar-state-success">
                         <img class="rounded-circle" src="<?php echo e(route('BaseUrl')); ?>/Pannel/assets/media/image/avatar.jpg" alt="...">
                     </figure>
                 </a>
...
<!-- end::navbar --><?php /**PATH C:\xampp\htdocs\Admin_pannel\resources\views/Layouts/Pannel/NavBar.blade.php ENDPATH**/ ?>