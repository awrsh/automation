...
<div class="container-fluid">
    ...
    <div class="card">
        ...
        <div class="card-body">
                ...
                <?php endif; ?>
                            <?php if(count($teacher_lessons)): ?>
                            <ul class="nav nav-pills mb-3" id="pills-tab2" role="tablist">
                                    <?php $__currentLoopData = $teacher_lessons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                       
                                        <li class="nav-item">
                                          <a class="nav-link <?php echo e($key == 0 ? ' active':''); ?>" id="pills-<?php echo e($item->id); ?>-tab" data-toggle="pill" href="#pills-<?php echo e($item->id); ?> " role="tab" aria-controls="pills-<?php echo e($item->id); ?>" aria-selected=" <?php echo e($key == 0 ? 'true':'false'); ?> ">
                               ...
                               <div class="tab-content" id="pills-tabContent2">
                                <?php $__currentLoopData = $teacher_lessons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>   
                                 ...
                                 <div class="tab-pane fade <?php echo e($key == 0 ? 'show active':''); ?>" id="pills-<?php echo e($item->id); ?>" role="tabpanel" aria-labelledby="pills-<?php echo e($item->id); ?>-tab">
                                          ...
                                          <table class="table table-striped table-bordered example2">
                                                  ...
                                                  <tbody>
                                                          ...
                                                          ?>
                                                      <?php $__currentLoopData = \App\Models\Student::where('student_student_class',$class_id)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$students): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
type:'get',
url:"<?php echo e(url('Manager/discipline/student_chart')); ?>",
data:{id:id},
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('Layouts.Teachers.Template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\automation\resources\views/Teachers/Pannel/AddDiscipline.blade.php ENDPATH**/ ?>