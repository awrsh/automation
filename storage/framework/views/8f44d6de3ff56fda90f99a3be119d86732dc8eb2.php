  ...
  <div class="row">
    <div class=" col-md-12">
      ...
      <div class="card">
        ...
        <div class="card-body">
          <form id="form" action=" <?php echo e(route('Student.EditClassShow')); ?> " method="post">
            <?php echo csrf_field(); ?>
                ...
                <div class=" col-md-5">
                  <div class=" form-group ">
                    ...
                    <select id="content2" class=" custom-select student_list_ul custom-select-lg mb-3" size="10" multiple>
                      ...
                      <?php $__currentLoopData = $list_ul; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $li): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($li->student_id); ?>"><?php echo e($li->student_firstname); ?> - <?php echo e($li->student_lastname); ?></option>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                  </div>
                </div>
...
<?php echo $__env->make('Layouts.Pannel.Template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\automation\resources\views/User/Students/EditClass.blade.php ENDPATH**/ ?>