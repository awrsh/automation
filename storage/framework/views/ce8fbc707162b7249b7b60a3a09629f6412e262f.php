    ...
    <div class="container-fluid">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action=" <?php echo e(route('ReportCard.Insert')); ?> " method="post">
                    <?php echo csrf_field(); ?>
                    <div class="mb-4">
                        <div class="row">
...
<?php echo $__env->make('Layouts.Pannel.Template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\automation\resources\views/User/ReportCard/AddReportCard.blade.php ENDPATH**/ ?>