 ...
 <div class="side-menu-body">
     <ul>
         ...
         <li><a href="#"><i class="icon ti-user"></i> <span>  دانش اموزان</span> </a>
             <ul>
                 <li><a href=" <?php echo e(route('BaseUrl')); ?> ">ثبت نام </a></li>
                 ...
                 <li><a href="#">کلاس بندی</a>  </li>
             </ul>
         </li>
       </ul>
 </div>
</div>
<!-- end::side menu --><?php /**PATH C:\xampp\htdocs\Admin_pannel\resources\views/Layouts/Pannel/SideBar.blade.php ENDPATH**/ ?>