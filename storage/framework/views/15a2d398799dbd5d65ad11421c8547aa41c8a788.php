                                       ...
                                       <div class="col-md-6">
                                            <table class="table table-striped table-bordered">
                                                    ...
                                                    <tbody> 
                                                       ...
                                                       <?php if(\App\ExerciseDailyModel::where('lesson_id',$lesson->id)->count()): ?>
                                                        <?php $__currentLoopData = \App\ExerciseDailyModel::where('lesson_id',$lesson->id)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $exercise): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php
                                                            $rand = rand();
                                                        ?>
                                                        <tr>
                                                                ...
                                                                <td>
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="checkbox" value="<?php echo e($lesson->id); ?>" name="status[]" class="custom-control-input switch" id="<?php echo e($rand); ?>">
                                                                        <label class="custom-control-label" for="<?php echo e($rand); ?>"><span class="text-danger">انجام نشده</span></label>
                                                                        </div>
                                                                    </div>
                                                                </td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('Layouts.Students.Template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\automation\resources\views/Students/Pannel/ExerciseInsert.blade.php ENDPATH**/ ?>