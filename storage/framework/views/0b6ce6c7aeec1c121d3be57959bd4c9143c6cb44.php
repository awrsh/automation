...
<div class="container-fluid">
    ...
    <ul class="nav nav-pills mb-3" id="pills-tab2" role="tablist">
        ...
        <li class="nav-item">
            <a class="nav-link <?php echo e($count == 0 ? 'active':''); ?>" id="pills-<?php echo e($key); ?>-tab" data-toggle="pill"
                href="#pills-<?php echo e($key); ?> " role="tab" aria-controls="pills-<?php echo e($key); ?>"
                aria-selected=" <?php echo e($count == 0 ? 'true':'false'); ?> ">
                <?php echo e($item); ?>
    ...
    <div class="tab-content" id="pills-tabContent2">
        ...
        <div class="tab-pane fade <?php echo e($count == 0 ? 'show active':''); ?>" id="pills-<?php echo e($key); ?>" role="tabpanel"
            ...
            <table class="table table-striped table-bordered example2">
                ...
                <tbody>
                    <?php
                    $class_id=\App\Models\ClassModel::where('class_name',$item)->first()->class_id;
                    ?>
                    ...
                    <tr>
                        ...
                        <td>20</td>
                        <td>
                            <a href=" <?php echo e(route('Teachers.WorkSpace.DisciplineShow',$students)); ?> " class=" text-center"><i
                                    class="fa fa-file-text-o fa-2x"></i></a>
                        </td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('Layouts.Teachers.Template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\automation\resources\views/Teachers/Pannel/DisciplineList.blade.php ENDPATH**/ ?>