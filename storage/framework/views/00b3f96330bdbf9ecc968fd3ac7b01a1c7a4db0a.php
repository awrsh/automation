...
<div class="container h-100-vh">
    <div class="row align-items-center h-100-vh">
        ...
        <div class="col-lg-4 offset-lg-1 p-t-b-25">
            ...
            <a class="d-block my-3 btn  btn-success" href="<?php echo e(route('CreateAccount')); ?>">ایجاد حساب کاربر جدید </a>
        </div>
    </div>
</div>

<?php $__env->stopSection(); ?>
<?php echo $__env->make('Layouts.FrontEnd.Template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\automation\resources\views/FrontEnd/login.blade.php ENDPATH**/ ?>