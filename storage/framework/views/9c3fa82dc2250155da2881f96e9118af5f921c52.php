    ...
    <div class="row">
        <div class=" col-md-12">
            ...
            <div class="card">
                ...
                <p>تعداد دانش آموز قابل ثبت  : <?php echo e($count); ?></p>
                        <div id="wizard2">
                            <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('Layouts.Pannel.Template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\automation\resources\views/User/Students/Register.blade.php ENDPATH**/ ?>