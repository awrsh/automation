...
<?php echo $__env->make('Layouts.Pannel.SettingSideBar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>;
...
<script src="<?php echo e(route('BaseUrl')); ?>/Pannel/assets/js/custom.js"></script>
<script src="<?php echo e(route('BaseUrl')); ?>/Pannel/assets/js/app.js"></script>
<!-- end::custom scripts -->

</body>
</html>
<?php /**PATH C:\xampp\htdocs\Admin_pannel\resources\views/Layouts/Pannel/Template.blade.php ENDPATH**/ ?>