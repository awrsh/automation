...
<div class="container h-100-vh">
    <div class="row align-items-center h-100-vh">
        ...
        <div class="col-lg-4 offset-lg-1 p-t-b-25">
            ...
            <?php endif; ?>
            <form action="<?php echo e(route('Student.WorkSpace.Login')); ?>" method="post">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('Layouts.FrontEnd.Template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\automation\resources\views/Students/Register/Login.blade.php ENDPATH**/ ?>