...
<div class="container-fluid">
    ...
    <div class="page-header">
        <div>
            <h3> گزارش مطالعه کلاسی </h3>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="#">صفحه اصلی</a></li>
                    <li class="breadcrumb-item"><a href="#">مطالعاتی</a></li>
                    <li class="breadcrumb-item active" aria-current="page"><a href="#">گزارش مطالعه کلاسی</a>
                    </li>
        ...
        <div class="card">
            ...
            <form id="form" action=" <?php echo e(route('Studing.InsertStudy')); ?> " method="post">
                <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('Layouts.Pannel.Template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\automation\resources\views/User/Studying/StudyingLessonsReport.blade.php ENDPATH**/ ?>